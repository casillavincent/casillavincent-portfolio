export const MY_PROJECTS = [
   {
      ...
      design:
         "For our design tools course final project, I created high-fidelity mockups using Photoshop and Adobe XD. Although it’s not identical to the final product, I wanted to keep aspects from my initial design once I started with development. I knew I wanted to have a sidebar, a fixed navigation in mobile view instead of a hamburger maintain the general layout of the mockup. For the basic design, I wanted to use colors that are dark, easy on the eyes and designate one accent color. Considering that the backbone of this project was to create a spin on IMDB and TMDB, I wanted to take layouts that are familiar and make them less crowded.",
      development:
